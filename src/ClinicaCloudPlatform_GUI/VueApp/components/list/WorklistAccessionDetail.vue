                        ...
                        <div class="card card-compact card-no-outer-border">
                            ...
                            <div class="card-block wrap-unset">
                                <div class="row m-0">
                                    ...
                                    <div class="col-auto" v-bind:id="'accSpecimenCount' + accession.id">
                                        <div class="m-0 p-0">
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col-auto" v-bind:id="'accCaseCount' + accession.id">
                                        <div class="m-0 p-0">
                                            N/A
                                        </div>
                                    </div>
...
<script src="./WorklistAccessionDetail.vue.js">
