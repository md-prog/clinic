        ...
        <div class="card card-accent-primary card-compact">
            ...
            <div class="card-block">
                <div class="row m-0" v-if="$route.name!=='Specimen Catalog'">
                    ...
                    <div v-if="specimen.id % 2 === 0" class="col-sm-3 m-0 p-0">
                        <div class="row">
                            <div class="col-sm-12 text-warning">Received (0)</div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="progress">
                    ...
                    <div v-if="specimen.id % 2 !== 0" class="col-sm-3 m-0 p-0">
                        <div class="row">
                            <div class="col-sm-12 text-success">Archived (-1)</div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="progress">
                    ...
                    <div class="col-sm-2 m-0 p-0"><div style="width:20px"></div></div>
                    <div class="col-sm-5 m-0 p-0">
                        <div class="row">
                            <div class="col-sm-auto">
                                <label class="label-black">Location: </label>
                            </div>
                            <div v-if="specimen.id % 2 === 0" class="col-sm-auto">
                        ...
                        <div class="card card-compact card-no-outer-border">
                            ...
                            <div class="card-block wrap-unset">
                                <div class="row m-0" v-for="att in getSpecimenAttributesBySection(col.sectionName, specimen.type.code)">
                                    <div class="col-sm-auto mr-1"><label v-bind:for="'attValue' + specimen.id + att.name" class="label-black"><strong>{{att.label}}</strong>:</label></div>
                                    <div class="col-sm-auto" v-bind:id="'attValue' + specimen.id + att.name">
