                                    ...
                                    <tr>
                                        <td>
                                            <button class="btn btn-info btn-sm"
                                                ...
                                                {{specimen.guid === specimensState.editingSpecimenGuid ? 'Done' : 'Click to View/Edit'}}
                                            </button>
                                        </td>
                                        <td>{{specimen.id}}</td>
                ...
                currentSpecimen:{
                    get: function(){
                        ...
                        if(vm.specimensState.editingSpecimenGuid === "" || vm.specimensState.editingSpecimenGuid === null)
                            return null;
                        return vm.specimens.find(function(s){
        ...
        public dynamic CustomData { get; set; }
                */
                ...
                this.$nextTick(function() {
                    this.collapseAllSpecimens();
                    this.expandSpecimen(newSpec.guid);
                });
            },
            ...
            specimenClicked: function(specimen){
                this.$nextTick(function() {this.collapseAllSpecimens();});
                ...
                this.$nextTick(function() {this.expandSpecimen(specimen.guid);});
            },

            expandSpecimen: function(guid){
                $('#collapse'+guid).collapse('show');
            },

            collapseAllSpecimens: function() {
