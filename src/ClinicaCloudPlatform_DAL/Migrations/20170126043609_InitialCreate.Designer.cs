...
namespace ArsMachinaLIMSDAL.Migrations
{
    ...
    [Migration("20170126043609_InitialCreate")]
    partial class InitialCreate
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ClinicaCloudPlatform.Model.Models.Accession", b =>
                {
                    ...
                    b.Property<int>("AuditLogReturnLevel");
            ...
            modelBuilder.Entity("ClinicaCloudPlatform.Model.Models.Audit", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<Guid?>("DashboardComponentGUID");

                    b.Property<Guid?>("DashboardGUID");

                    b.Property<Guid?>("DashboardSectionGUID");
                    ...
                    b.Property<Guid?>("FacilityGUID");

                    b.Property<Guid?>("LabGUID");
                    ...
                    b.Property<Guid?>("PanelResultGUID");

                    b.Property<Guid?>("PatientGUID");

                    b.Property<Guid?>("ReportDocumentGUID");
                    ...
                    b.Property<Guid?>("TestResultGUID");
                    ...
                    b.Property<Guid?>("WorkflowStepGUID");

                    b.Property<Guid?>("WorklistColumnGUID");

                    b.Property<Guid?>("WorklistConfigurationGUID");
                    ...
                    b.HasIndex("DashboardComponentGUID");

                    b.HasIndex("DashboardGUID");

                    b.HasIndex("DashboardSectionGUID");

                    b.HasIndex("DepartmentGUID");

                    b.HasIndex("DoctorGUID");

                    b.HasIndex("FacilityGUID");
                    ...
                    b.HasIndex("PanelResultGUID");

                    b.HasIndex("PatientGUID");

                    b.HasIndex("ReportDocumentGUID");
                    ...
                    b.HasIndex("WorkflowStepGUID");

                    b.HasIndex("WorklistColumnGUID");

                    b.HasIndex("WorklistConfigurationGUID");
            ...
            modelBuilder.Entity("ClinicaCloudPlatform.Model.Models.Audit", b =>
                {
                    ...
                    b.HasOne("ClinicaCloudPlatform.Model.Models.Comment")
                        .WithMany("AuditLog")
                        .HasForeignKey("CommentGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.DashboardComponent")
                        .WithMany("AuditLog")
                        .HasForeignKey("DashboardComponentGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.Dashboard")
                        .WithMany("AuditLog")
                        .HasForeignKey("DashboardGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.DashboardSection")
                        .WithMany("AuditLog")
                        .HasForeignKey("DashboardSectionGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.Department")
                        .WithMany("AuditLog")
                        .HasForeignKey("DepartmentGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.Doctor")
                        .WithMany("AuditLog")
                        .HasForeignKey("DoctorGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.Facility")
                        .WithMany("AuditLog")
                        .HasForeignKey("FacilityGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.Lab")
                        .WithMany("AuditLog")
                        .HasForeignKey("LabGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.Label")
                        .WithMany("AuditLog")
                        .HasForeignKey("LabelGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.Layout")
                        .WithMany("AuditLog")
                        .HasForeignKey("LayoutGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.Panel")
                        .WithMany("AuditLog")
                        .HasForeignKey("PanelGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.PanelResult")
                        .WithMany("AuditLog")
                        .HasForeignKey("PanelResultGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.Patient")
                        .WithMany("AuditLog")
                        .HasForeignKey("PatientGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.ReportDocument")
                        .WithMany("AuditLog")
                        .HasForeignKey("ReportDocumentGUID");
                    ...
                    b.HasOne("ClinicaCloudPlatform.Model.Models.SpecimenTransport")
                        .WithMany("AuditLog")
                        .HasForeignKey("SpecimenTransportGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.SpecimenType")
                        .WithMany("AuditLog")
                        .HasForeignKey("SpecimenTypeGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.Step")
                        .WithMany("AuditLog")
                        .HasForeignKey("StepGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.Test")
                        .WithMany("AuditLog")
                        .HasForeignKey("TestGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.TestResult")
                        .WithMany("AuditLog")
                        .HasForeignKey("TestResultGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.TestType")
                        .WithMany("AuditLog")
                    ...
                    b.HasOne("ClinicaCloudPlatform.Model.Models.WorkflowStep")
                        .WithMany("AuditLog")
                        .HasForeignKey("WorkflowStepGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.WorklistColumn")
                        .WithMany("AuditLog")
                        .HasForeignKey("WorklistColumnGUID");

                    b.HasOne("ClinicaCloudPlatform.Model.Models.WorklistConfiguration")
                        .WithMany("AuditLog")
                        .HasForeignKey("WorklistConfigurationGUID");
            ...
            modelBuilder.Entity("ClinicaCloudPlatform.Model.Models.DashboardSection", b =>
                {
                    b.HasOne("ClinicaCloudPlatform.Model.Models.Dashboard")
                        .WithOne("HeaderSection")
                        .HasForeignKey("ClinicaCloudPlatform.Model.Models.DashboardSection", "GUID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
